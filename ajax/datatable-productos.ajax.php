	...
	public function mostrarTablaProductos(){
    	...
    	$orden = "id";
		  ...
		  for($i = 0; $i < count($productos); $i++){
			  ...
			  if (is_array($categorias) && isset($categorias["categoria"])) {
				$categoriaValue = $categorias["categoria"];
			} else {
				$categoriaValue = "Categoría no disponible"; // O algún valor predeterminado
			}
